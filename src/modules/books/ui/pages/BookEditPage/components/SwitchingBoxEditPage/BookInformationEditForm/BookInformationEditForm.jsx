...
export default function BookInformationEditForm() {
    return (
        <Formik
            initialValues={{
            ...
            validationSchema={Yup.object({
                bookCover: Yup.mixed().required(
                    'Необходимо загрузить обложку книги'
                ),
                ...
                freeChaptersCount: Yup.number()
                    .integer()
                    .min(0, 'Количество должно быть положительным числом'),
            })}
                            ...
                            <Field name='bookCover'>
                                {({ field, form }) => (
                                    <>
                                        ...
                                        {form.errors.bookCover &&
                                            form.touched.bookCover && (
                                                <div>
                                                    {form.errors.bookCover}
                                                </div>
                                            )}
