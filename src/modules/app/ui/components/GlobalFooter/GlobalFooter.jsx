                ...
                <footer className={`${stl.pageFrame}`}>
                    <div className={stl.wrapperColumns}>
                        <div className={`${stl.column} ${stl.columnCenter}`}>
                            <h4 className={stl.socialNetworksTitle}>
                                Полезная информация:{' '}
                            </h4>
                            <LicenseAgreement />
                            <AboutLitterria />
                        ...
                        <div className={stl.smallColumn}>
                            ...
                            <p className={stl.warningNotice}>
                                <span className={stl.labelDanger}>18+</span>
                                Внимание! Сайт может содержать материалы, не
                                предназначенные для просмотра лицами, не
                                достигшими 18 лет!
                            </p>
                        </div>
                    </div>
