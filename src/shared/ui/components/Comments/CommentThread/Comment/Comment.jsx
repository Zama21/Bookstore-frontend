...
import Modal from 'modules/modals/ui/Components/Modals/BaseModals/Modal/Modal';
                ...
                <div className={stl.wrapperBottomComment}>
                    {replyCount != 0 && (
                        <button className={stl.replyCount} onClick={toggleArrow}>
                            ...
                            <span className={`${arrowType ? stl.arrowDown : stl.arrowUp}`}></span>
                        </button>
                    )}
                    {replyCount == 0 && <span></span>}
                    <div className='flxRowAndVrt'>
                        <CommentSvgSelector nameSvg='complaint' stl={stl}></CommentSvgSelector>
